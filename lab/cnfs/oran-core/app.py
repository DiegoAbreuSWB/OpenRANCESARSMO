"""
oran-core - simulador LEVE de um core 5G simplificado (tipo AMF).

ATENCAO: isto NAO implementa NAS/NGAP nem qualquer protocolo 3GPP/O-RAN real. E um workload
...
NF_NAME = os.environ.get("NF_NAME", "oran-core")
NF_TYPE = os.environ.get("NF_TYPE", "5GC-AMF-sim")
