...
shots = {
    ...
    "term-rapp-decision": (
        ...
        [
            ...
            "",
            "-- reverificacao final apos o fix (spec.replicas confirmado via kubectl) --",
            "oran-cu   2/2   2   2   (scale-up permanece estavel, RootSync nao reverte mais)",
        ],
    ),
    "term-metrics-top": (
    ...
    "term-validate-lab": (
        ...
        [
            "================ VALIDATE LAB :: 2026-09-25T11:31:43-03:00 ================",
            ...
            "6-10) demo-nf: deploy/ready/scale/recover/cleanup    [PASS] x5",
            "11) as 3 CNFs (oran-cu/du/core) via pacote Porch     [PASS]",
            "12) metrics-server responde (kubectl top)            [PASS]",
            "13) RootSync 'openran-cnfs' sincroniza sem erro      [PASS]",
            "14) config-bridge esta de pe                         [PASS]",
            "15) rapp-autoscale avaliando ciclos de politica      [PASS]",
            "",
            "================ RESUMO: PASS=15  FAIL=0  SKIP=0 ================",
        ],
    ),
}
